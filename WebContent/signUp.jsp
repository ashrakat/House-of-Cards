...
<body>
	...
	<%
			...
			HashMap<String, HttpSession> sessions = (HashMap<String, HttpSession>) application
	...
	<%
				...
				HashMap<String, HttpSession> search = (HashMap<String, HttpSession>) application
						.getAttribute("sessionManager");
	...
	<template id="signupin"> <nav class="navbar navbar-default">
			...
			<div class="modal-content">
				<div class="modal-header">
					<div class="modal-title">
						<center class="register">Registeration</center>
					</div>
				</div>
				<br>
				<center>
						...
						<div class="col-md-5 col-md-offset-1">
							<form action="SessionController" method="POST">
								<div class="input-group">
									<span class="input-group-addon input-group-sm"><i
										class="fa fa-user fa-lg"></i></span> <input type="text"
										class="form-control" name="name" placeholder="FullName">
								</div>
								<br>
								...
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-mobile fa-lg"></i></span> <input type="number"
								...
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-envelope-o fa-lg"></i></span> <input type="email"
